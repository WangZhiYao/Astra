...
from app.schemas import UserPurchaseTransaction, UserPurchaseTransactionCreate, UserPurchaseTransactionUpdate
...
@router.post("", status_code=status.HTTP_201_CREATED,
             response_model=Response[UserPurchaseTransaction])
...
@router.get("/{transaction_id}", response_model=Response[UserPurchaseTransaction])
...
@router.get("", response_model=Response[List[UserPurchaseTransaction]])
...
@router.put("/{transaction_id}", response_model=Response[UserPurchaseTransaction])
